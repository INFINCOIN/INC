Contributing to INFINCOIN
============================

The INFINCOIN project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/infincoin-project/infincoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the INFINCOIN project, and is not to be
confused with overall INFINCOIN Network Protocol consensus changes.

Whether a pull request is merged into INFINCOIN rests with the project merge
...
Patches that change INFINCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the INFINCOIN consensus, it must have been
...
The project leader is the release manager for each INFINCOIN release.
