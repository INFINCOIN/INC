...
class BlockIndexStatsTest(infincoinTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 INC "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 INC + 9 notes of 5 INC + 1 note of 4 INC (using 1.0 fee)
