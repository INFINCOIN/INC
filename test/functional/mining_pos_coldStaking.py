...
from test_framework.infincoin_node import infincoinTestNode
...
class INFINCOIN_ColdStakingTest(infincoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(infincoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 INC from the pot)
...
if __name__ == '__main__':
    INFINCOIN_ColdStakingTest().main()
