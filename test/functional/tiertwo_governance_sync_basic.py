...
from test_framework.test_framework import infincoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(infincoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.infincoin.org/t/test-proposal"
