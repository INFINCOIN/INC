...
class ListReceivedTest (infincoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 INC.
        ...
        # Send 1 INC to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 INC sending them all (fee is 0.1 INC)
        ...
        # Confirm transaction (2 INC from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 INC, send 0.6 INC + 0.05 INC fee
