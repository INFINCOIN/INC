...
INFINCOIN is now available at `./src/infincoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/INFINCOIN"

    touch "/Users/${USER}/Library/Application Support/INFINCOIN/infincoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/INFINCOIN/infincoin.conf"

The first time you run infincoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/INFINCOIN/debug.log

Other commands:
-------

    ./src/infincoind -daemon # Starts the infincoin daemon.
    ./src/infincoin-cli --help # Outputs a list of command-line options.
    ./src/infincoin-cli help # Outputs a list of RPC commands when the daemon is running.
