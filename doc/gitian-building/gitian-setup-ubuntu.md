...
The build script we'll be using is contained in the INFINCOIN github repository ([contrib/gitian-build.py](https://github.com/INFINCOIN/INC/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the INFINCOIN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/INFINCOIN/INC/master/contrib/gitian-build.py
