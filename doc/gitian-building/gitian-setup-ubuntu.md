...
The build script we'll be using is contained in the INFINCOIN github repository ([contrib/gitian-build.py](https://github.com/infincoin-project/infincoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the INFINCOIN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/INFINCOIN-Project/INFINCOIN/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, infincoin-detached-sigs, and infincoin GitHub repos.
