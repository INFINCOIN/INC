...
The script [extract-osx-sdk.sh](https://github.com/infincoin-project/infincoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
infincoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/infincoin-project/infincoin/blob/master/doc/README_osx.md) for troubleshooting tips.
