...
This document provides guidelines for internationalization of the INFINCOIN software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to INFINCOIN network</source>
        <translation>
            <numerusform>%n active connection to INFINCOIN network</numerusform>
            <numerusform>%n active connections to INFINCOIN network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `infincoin_en.ts` remains unchanged.
