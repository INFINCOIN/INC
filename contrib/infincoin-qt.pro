...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/infincoin-cli.cpp \
           src/infincoin-tx.cpp \
           src/infincoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/infincoin.qrc src/qt/infincoin_locale.qrc

TRANSLATIONS += src/qt/locale/infincoin_bg.ts \
                src/qt/locale/infincoin_de.ts \
                src/qt/locale/infincoin_en.ts \
                src/qt/locale/infincoin_es.ts \
                src/qt/locale/infincoin_fi.ts \
                src/qt/locale/infincoin_fr.ts \
                src/qt/locale/infincoin_it.ts \
                src/qt/locale/infincoin_ja.ts \
                src/qt/locale/infincoin_pl.ts \
                src/qt/locale/infincoin_pt.ts \
                src/qt/locale/infincoin_ru.ts \
                src/qt/locale/infincoin_sk.ts \
                src/qt/locale/infincoin_sv.ts \
                src/qt/locale/infincoin_vi.ts \
                src/qt/locale/infincoin_zh_CN.ts \
                src/qt/locale/infincoin_zh_TW.ts
