...
extern const char * const INFINCOIN_CONF_FILENAME;
extern const char * const INFINCOIN_PID_FILENAME;
extern const char * const INFINCOIN_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("infincoin-%s", name);
