...
#include "qt/infincoin/furabstractlistitemdelegate.h"
#include "qt/infincoin/txviewholder.h"
#include "qt/infincoin/tooltipmenu.h"
#include "qt/infincoin/sendmultirow.h"
#include "qt/infincoin/coldstakingmodel.h"
#include "qt/infincoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(INFINCOINGUI* parent);
    ~ColdStakingWidget();
