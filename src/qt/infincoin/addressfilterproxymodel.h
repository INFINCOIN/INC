...
#ifndef INFINCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define INFINCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //INFINCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
