...
#include "qt/infincoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(INFINCOINGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("INFINCOIN_tx_csv_export(*.csv)") : tr("INFINCOIN_addresses_csv_export(*.csv)"),
        nullptr);
