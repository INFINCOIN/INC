...
#include "qt/infincoin/settings/settingsnetworkwidget.h"
#include "qt/infincoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/infincoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(INFINCOINGUI* _window, QWidget *parent) :
