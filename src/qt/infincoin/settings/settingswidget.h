...
#include <QWidget>
#include "qt/infincoin/pwidget.h"
#include "qt/infincoin/settings/settingsbackupwallet.h"
#include "qt/infincoin/settings/settingsexportcsv.h"
#include "qt/infincoin/settings/settingsbittoolwidget.h"
#include "qt/infincoin/settings/settingssignmessagewidgets.h"
#include "qt/infincoin/settings/settingswalletrepairwidget.h"
#include "qt/infincoin/settings/settingswalletoptionswidget.h"
#include "qt/infincoin/settings/settingsmainoptionswidget.h"
#include "qt/infincoin/settings/settingsdisplayoptionswidget.h"
#include "qt/infincoin/settings/settingsmultisendwidget.h"
#include "qt/infincoin/settings/settingsinformationwidget.h"
#include "qt/infincoin/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(INFINCOINGUI* parent);
    ~SettingsWidget();
