...
#include "qt/infincoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/infincoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(INFINCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to INFINCOINGUI::handleRestart()
