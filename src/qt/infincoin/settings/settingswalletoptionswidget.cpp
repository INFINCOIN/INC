...
#include "qt/infincoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/infincoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(INFINCOINGUI* _window, QWidget *parent) :
