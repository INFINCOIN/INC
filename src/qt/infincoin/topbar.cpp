...
#include "qt/infincoin/topbar.h"
#include "qt/infincoin/forms/ui_topbar.h"
#include "qt/infincoin/lockunlock.h"
#include "qt/infincoin/qtutils.h"
#include "qt/infincoin/receivedialog.h"
#include "qt/infincoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/infincoin/balancebubble.h"
...
TopBar::TopBar(INFINCOINGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopInc, ui->labelAmountTopShieldedInc}, "amount-small-topbar");
    setCssProperty({ui->labelAmountInc}, "amount-topbar");
    setCssProperty({ui->labelPendingInc, ui->labelImmatureInc}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("INFINCOIN")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // INC Total
    QString totalInc = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // INC
    // Top
    ui->labelAmountTopInc->setText(totalTransparent);
    ui->labelAmountTopShieldedInc->setText(totalShielded);
    // Expanded
    ui->labelAmountInc->setText(totalInc);
    ui->labelPendingInc->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureInc->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
