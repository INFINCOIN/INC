...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, INFINCOINGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, INFINCOINGUI* gui, double posX = 3);
