...
#include "qt/infincoin/sendcustomfeedialog.h"
#include "qt/infincoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(INFINCOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &INFINCOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
