...
/** Utility functions used by the INFINCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render INFINCOIN addresses in monospace font
...
// Parse "infincoin:" URI into recipient object, return true on successful parsing
