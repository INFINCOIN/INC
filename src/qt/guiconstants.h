...
/* infincoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "INFINCOIN"
#define QAPP_ORG_DOMAIN "infincoin.org"
#define QAPP_APP_NAME_DEFAULT "INFINCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "INFINCOIN-Qt-testnet"
