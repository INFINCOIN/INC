...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            INFINCOINGUI* window = static_cast<INFINCOINGUI*>(parentWidget());
...
{
    INFINCOINGUI* gui = static_cast<INFINCOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<INFINCOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("INFINCOIN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your INCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
