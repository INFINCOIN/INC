...
public:
    ...
    /**
     * Amount of infincoin coming in to a transaction
...
// INFINCOIN: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
